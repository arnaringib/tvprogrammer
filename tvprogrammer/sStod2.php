...
<input type="button" value="Fyrri vika" onclick="getLastStod2()"/>
<input type="button" value="N&aelig;sta vika" onclick="getNextStod2()"/>
<div id="test"></div>
<table>
	<tr>
		<td class="day">
		...
		<td class="day">
			<table>
				...
				<tr><td><?php getStod2(date('Y-m-d', mktime(0, 0, 0, date("m"), $date+1, date("Y")))); ?></td></tr>
			</table>
		</td>
		<td class="day">
			<table>
				...
				<tr><td><?php getStod2(date('Y-m-d', mktime(0, 0, 0, date("m"), $date+2, date("Y")))); ?></td></tr>
			</table>
		</td>
		<td class="day">
			<table>
				...
				<tr><td><?php getStod2(date('Y-m-d', mktime(0, 0, 0, date("m"), $date+3, date("Y")))); ?></td></tr>
			</table>
		</td>
		<td class="day">
			<table>
				...
				<tr><td><?php getStod2(date('Y-m-d', mktime(0, 0, 0, date("m"), $date+4, date("Y"))));?></td></tr>
			</table>
		</td>
		<td class="day">
			<table>
				...
				<tr><td><?php getStod2(date('Y-m-d', mktime(0, 0, 0, date("m"), $date+5, date("Y")))); ?></td></tr>
		</table>
		</td>
		<td class="day">
			<table>
				...
				<tr><td><?php getStod2(date('Y-m-d', mktime(0, 0, 0, date("m"), $date+6, date("Y"))));?></td></tr>
			</table>
		</td>
	</tr>
</table>
