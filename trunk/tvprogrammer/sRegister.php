...
<tr>
	<td>Notendanafn:</td><td><input type="text" name="username" <?php if($fail) echo 'value=' . $_GET['username']; ?> /></td><td></td>
</tr>
<tr>
	<td>Lykilor&eth;:</td><td><input type="password" name="password" /></td><td><?php if($fail) echo 'Lykilor&eth;in voru ekki eins reyndu aftur.' ?></td>
</tr>
<tr>
